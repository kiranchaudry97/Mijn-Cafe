    ...
    <ul class="flex flex-wrap justify-center md:justify-end space-x-6 text-sm font-semibold">
      ...
      @else
        <li class="relative group">
          ...
          <ul
            class="absolute left-0 mt-2 w-36 bg-gray-800 border border-gray-700 rounded shadow-lg opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-opacity z-10"
          >
            <li>
              <a href="{{ route('login') }}"
